...
fun ReplySearchBar(modifier: Modifier = Modifier) {
    /**
     * Our custom search bar at the top doesn't have a clear background as the design requests.
     * By default, it falls back to the default base surface. You can provide a background to
     * give a clear separation.
     */
    Row(
        modifier = modifier
            .fillMaxWidth()
